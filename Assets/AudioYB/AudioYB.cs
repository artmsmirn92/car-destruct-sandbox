...
public class AudioYB : MonoBehaviour
{
    ...
    public bool Enabled
    {
        get => m_Source.enabled;
        set => m_Source.enabled = value;
    }
    ...
    public string Clip
    {
        get => m_Source.clip.name;
        set => m_Source.clip = AudioStreamCash.Find(value).cash;
    }

    public int TimeSamples
    {
        get => m_Source.timeSamples;
        set => m_Source.timeSamples = value;
    }
    ...
    public IEnumerator EndFile(string _Name)
    {
        ...
        if (clipYb == null)
            Debug.LogError($"Клип нулевой - {_Name}");
        m_Load = false;
        m_Play = true;
        if (clipYb != null)
